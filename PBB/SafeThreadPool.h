 ...
 */
class PBB_EXPORT SafeThreadPool
{
  ...
  public:
    ...
    class PBB_EXPORT Proxy final
    {
      ...
      private:
        friend class SafeThreadPool; // Only the thread pool can construct this object
    ...
    SafeThreadPool();
    ~SafeThreadPool();
    SafeThreadPool(const SafeThreadPool&) = delete;
    SafeThreadPool& operator=(const SafeThreadPool&) = delete;
  ...
  public:
    static SafeThreadPool& GetInstance();
};
