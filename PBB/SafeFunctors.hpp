...
class SafeFunctors
{
  public:
    ...
    //--------------------------------------------------------------------------------
    SafeFunctors(const SafeFunctors& other);

    //--------------------------------------------------------------------------------
    void operator=(const SafeFunctors& other);
...
template <BackendType Backend>
void SafeFunctors<Backend>::SetNestedParallelism(bool isNested)
{
    this->NestedActivated = isNested;
}

template <BackendType Backend>
bool SafeFunctors<Backend>::GetNestedParallelism()
{
    return this->NestedActivated;
}

template <BackendType Backend>
bool SafeFunctors<Backend>::IsParallelScope()
{
    return this->IsParallel;
}

template <BackendType Backend>
SafeFunctors<Backend>::SafeFunctors()
...
template <BackendType Backend>
SafeFunctors<Backend>::SafeFunctors(const SafeFunctors& other)
...
template <BackendType Backend>
void SafeFunctors<Backend>::operator=(const SafeFunctors& other)
{
